    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="d-flex mb-4">
          ...
          @click="getProducts">重新取得資料</button>
        </div>
        <!-- content -->
            ...
            <div class="col-md-4 mb-4" v-for="(item) in filterData" :key="item.id">
              <div class="card border-0 box-shadow text-center h-100">
                ...
                <div class="card-footer border-top-0 bg-white">
                  <button class="btn btn-outline-secondary btn-block btn-sm" @click="addtoCart(item.id)">
...
<script>
import { mapGetters, mapActions } from 'vuex'; // 關鍵字 mapGetters 表示 vuex 所有的 getters
...
export default {
  ...
  methods: {
    ...
    ...mapActions('productsModules', ['getProducts']), // 無法帶參數
  },
  created() {
    this.getProducts();
  },
